...
As you'll note from this output, the syntax provided from `show_query` is a bit different from the examples above, relying on an unnecessary subquery. **It does not include group_by? Why sub-query? CTEs?**
